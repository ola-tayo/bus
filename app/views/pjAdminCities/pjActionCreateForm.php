...
?>
<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminCities&amp;action=pjActionCreate" method="post" id="frmCreateCity">
	<input type="hidden" name="city_create" value="1" />
    <div class="panel-heading bg-completed">
        <p class="lead m-n"><?php __('infoAddCityTitle');?></p>
    </div><!-- /.panel-heading -->

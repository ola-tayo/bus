    ...
    <div class="col-sm-12">
        <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-6">
                <h2><?php __('infoTicketTemplateTitle') ?></h2>
            </div>
        ...
        <p class="m-b-none"><i class="fa fa-info-circle"></i><?php __('infoTicketTemplateDesc') ?></p>
    </div><!-- /.col-md-12 -->
</div>
						...
						<div class="row">
                            <div class="col-lg-11">
                                <div class="form-group">
                                    <label class="col-lg-3 col-md-4 control-label"><?php __('opt_o_ticket_template') ?><br/><small><?php __('lblTemplateTokens')?></small></label>
                                    ...
                                    <div class="col-lg-9 col-md-8 ">
                                        ...
                                        foreach ($tpl['lp_arr'] as $v)
                                        {
                                            ...
                                            <div class="<?php echo $tpl['is_flag_ready'] ? 'input-group ' : NULL;?>pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : 'table'; ?>">
                                                <textarea name="i18n[<?php echo $v['id']; ?>][o_ticket_template]" class="form-control mceEditor" style="height: 260px;"><?php echo htmlspecialchars(stripslashes(@$tpl['arr']['i18n'][$v['id']]['o_ticket_template'])); ?></textarea>
                                                <?php if ($tpl['is_flag_ready']) : ?>

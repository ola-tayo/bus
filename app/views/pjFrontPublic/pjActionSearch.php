	...
	<div class="panel panel-default pjBsMain">
		...
		<div class="panel-body pjBsBody">
			<div class="pjBsForm pjBsFormAvailability">
				...
				<form id="bsSearchForm_<?php echo $index;?>" action="<?php echo PJ_INSTALL_URL; ?>index.php?controller=pjFront&amp;action=pjActionCheck" method="post" >
					<input type="hidden" id="bsIsReturn_<?php echo $index;?>" name="is_return" value="<?php echo (isset($STORE['is_return']) && $STORE['is_return'] == 'T')  ? 'T' : 'F';?>" />
					<div class="row">
								...
								<div class="<?php echo $class;?>">
									<div class="form-group">
										...
										<div class="input-group pjBsDatePicker pjBsDatePickerFrom">
											<input type="text" id="bsDate_<?php echo $index;?>" name="date" class="form-control required" readonly="readonly" value="<?php echo isset($STORE) && isset($STORE['date']) ? htmlspecialchars($STORE['date']) : date($tpl['option_arr']['o_date_format']) ; ?>" data-msg-required="<?php __('front_required_field', false, true);?>"/>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-xss-12" style="display: <?php echo $one_way==true? 'none' : 'block';?>">
									<div class="form-group">
										...
										<div class="input-group pjBsDatePicker pjBsDatePickerTo" data-year="<?php echo date('Y', strtotime($min_to));?>" data-month="<?php echo date('n', strtotime($min_to));?>" data-day="<?php echo date('j', strtotime($min_to));?>">
											<input type="text" id="bsReturnDate_<?php echo $index;?>" name="return_date" class="form-control required" readonly="readonly" value="<?php echo isset($STORE) && isset($STORE['return_date']) ? htmlspecialchars($STORE['return_date']) : date($tpl['option_arr']['o_date_format']) ; ?>"/>
											<span class="input-group-addon">
												<span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>
											</span>
										</div><!-- /.input-group pjCcDatePicker -->
							...
							<div class="row pjBsSelectsRow">
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-6">
									<div class="form-group">
										...
										<div id="bsPickupContainer_<?php echo $index;?>">	
											<select id="bsPickupId_<?php echo $index;?>" name="pickup_id"  class="form-control pjBsAutocomplete required" data-msg-required="<?php __('front_required_field', false, true);?>">
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-6">
									<div class="form-group">
										...
										<div id="bsReturnContainer_<?php echo $index;?>">		
											<?php
											if(!isset($tpl['return_location_arr']))
											{ 
												?>
												<select id="bsReturnId_<?php echo $index;?>" name="return_id" class="form-control pjBsAutocomplete required" data-msg-required="<?php __('front_required_field', false, true);?>">
												...
												?>
												<select id="bsReturnId_<?php echo $index;?>" name="return_id" class="form-control pjBsAutocomplete">
													<option value="">-- <?php __('front_choose'); ?>--</option>
													<?php
						...
						<aside class="col-lg-6 col-md-6 col-sm-6 col-xs-12 pjBsFormAside">
							<article class="pjBsFormArticle">
								...
								?>
								<p>
									<?php echo $tpl['content_arr']['content'][0]['content'];?>
								</p>
